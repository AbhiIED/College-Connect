      ...
      <section className="relative pt-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg text-indigo-100/90 leading-relaxed max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link to="/directory" className="inline-flex items-center gap-2 bg-white text-indigo-700 px-6 py-3 rounded-xl font-semibold text-sm shadow-lg hover:shadow-xl hover:bg-indigo-50 transition-all">
                <Users className="w-4 h-4" /> Explore Directory
              </Link>
              <Link to="/feed" className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white px-6 py-3 rounded-xl font-semibold text-sm border border-white/20 hover:bg-white/25 transition-all">
